...
This document describes the configuration options for NeuralLog Python.

## Configuration Options

The Python can be configured using the following options:
...
```javascript
const { Component } = require('@neurallog/python');
...
Python also supports configuration via environment variables:
...
You can also configure Python using a configuration file:
